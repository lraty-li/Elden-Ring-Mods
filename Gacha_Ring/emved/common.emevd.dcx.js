...
$Event(9972, Default, function(X0_4) {
    ...
    // RandomlySetEventFlagInRange(1062265000,1062265001,ON);
    // RandomlySetEventFlagInRange(1062265001,1062265002,ON);
    // RandomlySetEventFlagInRange(1062265002,1062265003,ON);
    // RandomlySetEventFlagInRange(1062265003,1062265004,ON);
    // RandomlySetEventFlagInRange(1062265004,1062265005,ON);
    // RandomlySetEventFlagInRange(1062265005,1062265006,ON);
    // RandomlySetEventFlagInRange(1062265006,1062265007,ON);
    // RandomlySetEventFlagInRange(1062265007,1062265008,ON);
    // RandomlySetEventFlagInRange(1062265008,1062265009,ON);
    // RandomlySetEventFlagInRange(1062265009,1062265010,ON);
    // RandomlySetEventFlagInRange(1062265010,1062265011,ON);
    // RandomlySetEventFlagInRange(1062265011,1062265012,ON);
    // RandomlySetEventFlagInRange(1062265012,1062265013,ON);
